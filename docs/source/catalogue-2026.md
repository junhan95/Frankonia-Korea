...
`spec`은 끝났다. 남은 것은 각 페이지의 **본문 산문**이다. 카탈로그의 설명 문단과
Features 불릿, Performance & Compliance를 옮기면 "콘텐츠 준비 중" 밴드를 그 페이지에서
걷어낼 수 있다. 기술 토픽 4개(Frankosorb 58 · Shielding 62 · Automation 64 ·
Services 6–7)는 모델이 없는 페이지라 처음부터 산문 작업이다.
