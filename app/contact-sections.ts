...
export const contactMeta = {
  ko: {
    label: "문의",
    description:
      "Frankonia 사업장 다섯 곳의 연락처 — 독일 하이데크 본사와 포르히하임, 중국 자산, 인도 첸나이, 그리고 한국. 견적·기술 문의를 보내실 곳과, 문의에 담으면 좋은 세 가지.",
  },
  en: {
    label: "Contact",
    description:
      "Contact details for all five Frankonia offices — Heideck and Forchheim in Germany, Jiashan in China, Chennai in India, and Korea. Where to send a quotation or technical enquiry, and what to put in it.",
  },
} as const satisfies Record<Lang, { label: string; description: string }>;

/**
 * The offices, exactly as the head office lists them on its own contact page,
 * with the Korean office appended.
 *
