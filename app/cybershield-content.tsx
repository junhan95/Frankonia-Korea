...
/* CyberShield, inside the Frankonia Korea chrome.

   The product site cannot be embedded: it answers with
   ...
   origin. So the content is rendered natively here instead — same header,
   same footer, same design tokens — with links out to the product site for
   the full specifications and the room configurator. */
    ...
    <>
      ...
      <div className="hero" id="top">
        <div className="wrap hero-in">
          ...
          <p>{t.p}</p>
          <div className="btns">
            <a className="btn btn-red" href={cyberShieldUrl(lang)}>{t.b1}</a>
      ...
      <div className="band" id="contact">
        ...
        <p>{t.ctP}</p>
        <div className="btns">
          <a className="btn btn-red" href={cyberShieldUrl(lang)}>{t.ctB1}</a>
