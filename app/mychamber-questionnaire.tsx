...
const copy = {
  ko: {
    ...
    mailSubject: (id: QuestionnaireId, company: string) => `[MyChamber] 맞춤 설문 ${id} — ${company}`,
    mailAnswers: "설문 내용",
    mailFrom: "문의자",
    mailPhone: "전화",
    none: "—",
    mailFoot: "이 메일은 Frankonia MyChamber 맞춤 설문에서 자동 작성되었습니다.",
  },
  en: {
    ...
    mailSubject: (id: QuestionnaireId, company: string) => `[MyChamber] Questionnaire ${id} — ${company}`,
    mailAnswers: "Questionnaire answers",
    mailFrom: "Enquirer",
    mailPhone: "Phone",
    none: "—",
    mailFoot: "Written automatically by the Frankonia MyChamber questionnaire.",
  },
} as const;
